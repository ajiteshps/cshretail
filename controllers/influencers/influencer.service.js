    ...
    try {
        ...
        if (is_Validate) {
            ...
            if (validation.issetNotEmpty(req.headers.agentid)) {
                WhereClouse.push({ "fieldName": "asm__c", "fieldValue": req.headers.agentid ,"fieldName":"Attached_retailer__c","fieldValue":"ASC","fieldName":"Attached_retailer__c","fieldValue":"OEM","fieldName":"Attached_retailer__c","fieldValue":"Customer_Sales_Service","fieldName":"Attached_retailer__c","fieldValue":"Dealers_Sales_Service","fieldName":"Attached_retailer__c","fieldValue":"Retailers_Sales_Service","fieldName":"attached_dealer__c","fieldValue":"ASC","fieldName":"attached_dealer__c","fieldValue":"OEM","fieldName":"attached_dealer__c","fieldValue":"Customer_Sales_Service","fieldName":"attached_dealer__c","fieldValue":"Dealers_Sales_Service","fieldName":"attached_dealer__c","fieldValue":"Retailers_Sales_Service"});
            }
            if (validation.issetNotEmpty(req.query.name)) {
                WhereClouse.push({ "fieldName": "name", "fieldValue": req.query.name, "type":"LIKE","fieldName":"Attached_retailer__c","fieldValue":"ASC","fieldName":"Attached_retailer__c","fieldValue":"OEM","fieldName":"Attached_retailer__c","fieldValue":"Customer_Sales_Service","fieldName":"Attached_retailer__c","fieldValue":"Dealers_Sales_Service","fieldName":"Attached_retailer__c","fieldValue":"Retailers_Sales_Service","fieldName":"attached_dealer__c","fieldValue":"ASC","fieldName":"attached_dealer__c","fieldValue":"OEM","fieldName":"attached_dealer__c","fieldValue":"Customer_Sales_Service","fieldName":"attached_dealer__c","fieldValue":"Dealers_Sales_Service","fieldName":"attached_dealer__c","fieldValue":"Retailers_Sales_Service" });
            }
            if (validation.issetNotEmpty(req.query.email)) {
                WhereClouse.push({ "fieldName": "email", "fieldValue": req.query.email, "type":"LIKE","fieldName":"Attached_retailer__c","fieldValue":"ASC","fieldName":"Attached_retailer__c","fieldValue":"OEM","fieldName":"Attached_retailer__c","fieldValue":"Customer_Sales_Service","fieldName":"Attached_retailer__c","fieldValue":"Dealers_Sales_Service","fieldName":"Attached_retailer__c","fieldValue":"Retailers_Sales_Service","fieldName":"attached_dealer__c","fieldValue":"ASC","fieldName":"attached_dealer__c","fieldValue":"OEM","fieldName":"attached_dealer__c","fieldValue":"Customer_Sales_Service","fieldName":"attached_dealer__c","fieldValue":"Dealers_Sales_Service","fieldName":"attached_dealer__c","fieldValue":"Retailers_Sales_Service" });
            }
            if (validation.issetNotEmpty(req.query.phone)) {
                WhereClouse.push({ "fieldName": "phone", "fieldValue": req.query.phone, "type":"LIKE","fieldName":"Attached_retailer__c","fieldValue":"ASC","fieldName":"Attached_retailer__c","fieldValue":"OEM","fieldName":"Attached_retailer__c","fieldValue":"Customer_Sales_Service","fieldName":"Attached_retailer__c","fieldValue":"Dealers_Sales_Service","fieldName":"Attached_retailer__c","fieldValue":"Retailers_Sales_Service","fieldName":"attached_dealer__c","fieldValue":"ASC","fieldName":"attached_dealer__c","fieldValue":"OEM","fieldName":"attached_dealer__c","fieldValue":"Customer_Sales_Service","fieldName":"attached_dealer__c","fieldValue":"Dealers_Sales_Service","fieldName":"attached_dealer__c","fieldValue":"Retailers_Sales_Service" });
            }
